    ...
    public LayoutAdminAdd(){
        ...
        dodajButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (conn != null) {
                    try {
                        // Dodanie mechanika do twojej aplikacji
                        ...
                        try (PreparedStatement pstmtMechanic = conn.prepareStatement(sqlMechanic)) {
                            ...
                            pstmtMechanic.setString(4, password); // W prawdziwych aplikacjach hasło powinno być zahashowane
                        ...
                        // Nadanie uprawnień użytkownikowi bazy danych
                        ...
                        // Możesz tutaj zamknąć obecne okno i otworzyć kolejne
                        LayoutAdminAdd.this.dispose();
                         new LayoutAdmin().setVisible(true);
